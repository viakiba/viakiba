...
public class DynamicEngine {
    ...
    private DynamicEngine() {
        //获取类加载器
        this.parentClassLoader = new URLClassLoader(new URL[]{});
        //创建classpath
        this.buildClassPath();
    }
    /**
     ...
     */
    public byte[] javaCodeToObject(String fullClassName, String javaCode) throws IllegalAccessException, InstantiationException {
        ...
        jfiles.add(new JavaClassObject(fullClassName, javaCode));
    ...
    public static void redefineClass(String fullClassName, String javaCode) throws Exception {
        DynamicEngine de = DynamicEngine.getInstance();
        byte[] instance =  de.javaCodeToObject(fullClassName,javaCode);
        Instrumentation install = ByteBuddyAgent.install();
        Class<?> aClass = Class.forName(fullClassName);
        install.redefineClasses(new ClassDefinition(aClass,instance));
    }
}