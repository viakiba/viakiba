					...
					<div class="col-xs-12" style="margin-top: 30px">
						...
						<form class="form-horizontal" role="form">
							<div class="form-group">
								...
								<h3 class="blue">机构信息:</h3>
								<!-- <label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 机构名 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入机构完整名称"
							...
							<!-- <div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="form-field-1"> 企业注册人 </label>

								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入详细地址"
										class="col-xs-10 col-sm-5">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" placeholder="请输入电话"
										class="col-xs-10 col-sm-5">
								</div>
							</div>
													...
													<tbody>
														<s:iterator value="list" var="list">
															<tr>
																...
																<td><s:property value="#list.mechanismName" /></td>
																<td><s:property value="#list.address" /></td>
																<td class="hidden-480"><s:property
																		value="#list.telephone" /></td>


																<td class="hidden-480"><s:property
																		value="#list.responsibleUserId" /></td>
																<td>
																<a href="<s:url action="deleteMechanism.action">  
																<s:param name="id" value="#list.mechanismId"/> 
																</s:url>">
