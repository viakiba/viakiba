				...
				<div class="page-content">
					...
					<div class="col-xs-12" style="margin-top: 30px">
						...
						<form class="form-horizontal" role="form"
							action="addMechanism.action" method="post">
							<div class="form-group">

								<h3 class="blue">机构信息:</h3>

								<div align="center">
									<s:select name="mech.responsibleUserId" list="list"
										listKey="userId" listValue="userName" headerKey="0"
										headerValue="heheda"></s:select>
								</div>
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1"
										name="mech.mechanismName" placeholder="请输入机构完整名称"
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1" name="mech.address"
										placeholder="请输入详细地址" class="col-xs-10 col-sm-5">
								</div>
							</div>
							<div class="space-4"></div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" id="form-field-1"
										name="mech.telephone" placeholder="请输入电话"
										class="col-xs-10 col-sm-5">
								</div>
							</div>
							<div class="space-4"></div>
